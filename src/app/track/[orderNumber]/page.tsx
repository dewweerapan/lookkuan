...
export default async function TrackOrderPage({
  ...
  const job = await getJobByOrderNumber(decodeURIComponent(orderNumber))
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center mb-6">
            ...
            <p className="text-gray-500 mb-2">
              ไม่พบเลขที่ใบงาน{' '}
              <span className="font-mono font-bold text-gray-700">{decodeURIComponent(orderNumber)}</span>
            </p>
              ...
              {job.estimated_completion_date && !isDelivered && (
                <div className="flex justify-between">
                  ...
                  <span className={`font-medium ${
                    new Date(job.estimated_completion_date) < new Date() && !isReadyToPickup && !isDelivered
                      ? 'text-red-600'
                      : 'text-gray-800'
                  }`}>
