...
export default function ReportsExportButton({ topProductsList, paymentBreakdown }: Props) {
  const handleExport = () => {
  ...
  return (
    <button onClick={handleExport} className="pos-btn-secondary text-sm px-4 py-2">
      📥 Export สินค้าขายดี
    </button>
  )
}
