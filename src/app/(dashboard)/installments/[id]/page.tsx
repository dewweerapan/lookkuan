          ...
          <div className='bg-white rounded-xl border border-gray-200 p-6'>
            <div className='flex items-center justify-between mb-4'>
              ...
              <span className='text-sm text-gray-500'>
                {paidCount}/{plan.num_installments} งวด
              </span>
            </div>
            {/* Progress bar */}
            <div className='w-full bg-gray-200 rounded-full h-2 mb-4'>
              <div
                ...
                style={{
                  width: `${plan.num_installments > 0 ? (paidCount / plan.num_installments) * 100 : 0}%`,
                }}
              />
            </div>
                    ...
                    <div className='flex-1'>
                      ...
                      {payment.paid_at && (
                        <p className='text-xs text-green-600'>
                          ชำระเมื่อ: {formatDateTime(payment.paid_at)}
                        </p>
                      )}
                    </div>
          ...
          <div className='bg-white rounded-xl border border-gray-200 p-6'>
            ...
            <div className='space-y-3'>
              ...
              <div>
                ...
                <div className='mt-1'>
                  <span
                    className={`text-sm px-3 py-1 rounded-full font-semibold ${STATUS_COLORS[plan.status]}`}
                  >
          ...
          <div className='bg-white rounded-xl border border-gray-200 p-6'>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex justify-between'>
                ...
                <span
                  className={`font-bold text-xl ${Number(plan.balance_amount) - totalPaid > 0 ? 'text-orange-600' : 'text-green-600'}`}
                >
                  {formatCurrency(
                    Math.max(0, Number(plan.balance_amount) - totalPaid),
                  )}
                </span>
              </div>
            </div>
